  ...
  if (t.isObjectExpression(css)) {
    ...
    css.properties = css.properties.reduce(function propertiesReducer(acc, property) {
      ...
      if (t.isMemberExpression(property.key) || t.isCallExpression(property.key)) {
        ...
        elem.node.attributes.push(t.jSXAttribute(t.jSXIdentifier(name.name), t.jSXExpressionContainer(property.key)));
      ...
      .every(x => !x(property.value))) {
        replaceObjectWithPropFunction = true;
        const name = getLocalIdentifier(path);
        elem.node.attributes.push(t.jSXAttribute(t.jSXIdentifier(name.name), t.jSXExpressionContainer(property.value)));
